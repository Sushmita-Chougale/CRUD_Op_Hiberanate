...
<%
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select customer_name, pesticide_billing.product_name, pesticide_billing.village, pesticide_billing.company, pesticide_billing.weight, pesticide_billing.quantity, pesticide_billing.salePriceWithoutTax, pesticide_billing.total_per_product, pesticide_billing.total_all_product, pesticide_billing.transportation_expense, pesticide_billing.hamali_expense, pesticide_billing.gross_total, pesticide_billing.tax_percentage,pesticide_billing.hsn,pesticide_billing.iGst from pesticide_billing where bill_no =" + billno);
		...
		table_cell = new PdfPCell(new Phrase("Pesticides P.L.No.", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		//-----------------
		...
		table_cell = new PdfPCell(new Phrase("001/NRML/2017", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
