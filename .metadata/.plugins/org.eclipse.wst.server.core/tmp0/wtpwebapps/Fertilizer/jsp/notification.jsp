...
<body background="/Fertilizer/staticContent/images/all.jpg"> 
  ...
  <div class="container col-sm-offset-2">
 	 <div class="row form-group col-md-offset-2 ">
 		<button style="height: 150px;width: 285px" id = "blinker" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#expiryProducts">Upcoming Expiry Date Products<br>click to view</button>
			      ...
			      <div class="modal-content">
			         ...
			         <div class="modal-header" style="background-color:white;">
			            ...
			            <h4 class="modal-title" id="myModalLabel">
			              Products Expire Within 10 Days
			            </h4>
			         </div>
			         <!-- Modal Body -->
...
<!-- For Stock for seed and pesticide -->
 ...
 <button style="height: 150px;width: 285px" id="blinker1" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#reOrderProducts">Low Stock Products<br>click to view</button>
</div>
<!-- Modal -->
<div class="modal fade" id="reOrderProducts" tabindex="-1" role="dialog" 
   aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <!-- Modal Header -->
...
<div class="row form-group col-md-offset-2 ">
 <button style="height: 150px;width: 285px" class="btn btn-primary btn-lg" onclick="goToHome()">Home</button>
...
<script type="text/javascript">
					...
					function goToDashBoard(){
					    window.location = '/Fertilizer/jsp/index.jsp';
					} 
