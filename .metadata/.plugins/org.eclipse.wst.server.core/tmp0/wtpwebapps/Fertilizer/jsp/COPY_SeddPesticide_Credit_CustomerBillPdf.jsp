...
<%
	...
	try {
		...
		table_cell = new PdfPCell(new Phrase("Seeds L.No.", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		//-----------------
		...
		table_cell = new PdfPCell(new Phrase("NML/17/DAO/SD/2017/992", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		...
		float[] columnWidths3 = { 0.3f, 0.3f,0.2f, 0.2f, 0.1f, 0.2f, 0.3f };
...
/* 			table_cell3 = new PdfPCell(new Phrase(String.valueOf(halfGST), font12NoBold));
			...
			if(GST == 5.00 || GST == 12.00 || GST == 18 || GST == 28){
				double taxAmount = (GST/100)*(salep);
				//double newSalePrice = salep + taxAmount;
