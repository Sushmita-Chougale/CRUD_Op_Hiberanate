	...
	<div class="row footer navbar-fixed-bottom" style="background-color:#8c7674;">
		...
		<!-- <div class="col-md-12">
			<div class="" align="center">
				<h4 class="gradient" align="center" style="color:white;">&copy 2017 Embel Technologies Pvt.Ltd , visit us @ <a target="_blank" href="https://www.embel.co.in"><font color="black">www.embel.co.in</font> </a></h4>
			</div>
		...
		<div class="col-md-12" class="row footer navbar-fixed-bottom" style="background-color:#8c7674;">
			<div class="table-responsive">
			  <marquee onmouseover="this.stop()" onmouseout="this.start()" scrollamount="4" style="height: 45px;">			
			   <table class="table">
				<tbody>
					<tr>
						<div class="btn-group">
