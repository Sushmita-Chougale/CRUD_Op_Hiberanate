...
<head> 
	<meta charset="utf-8">
	<script type="text/javascript" src="/Fertilizer/staticContent/js/employeeDetails.js"></script>
			...
			<div class="row form-group">
 			...
 			<div class="form-group row">
            	...
            	<!--  "employeedetails()" function is implemented in employeeDetails.js  -->
        	    	...
        	    	<input style=" height: 65px; width: 180; font-size: 25" type="button" value="Employee List" id="listBtn" class="btn btn-primary" onclick="employeelist()" /> 
              	<input style=" height: 65px; width: 180; font-size: 25" type="button" value="Edit" id="listBtn" class="btn btn-primary" onclick="editEmployee()" /> 
        	    </div>
          	</div>
