...
<meta charset="utf-8">
<head>
<script type="text/javascript" src="/Fertilizer/staticContent/js/userDetails.js"></script>
	<script type="text/javascript">
	function openLogin(){
		 window.location = '/Fertilizer/jsp/login.jsp';
	}
	</script>
	</head>
	           ...
	           <label class="col-md-2 control-label" for="contactNo">Contact No.<sup>*</sup></label>  
						...
						<div class="input-group">
							<span class="input-group-addon">
              				...
              				<input id="contactNo" name="contactNo" placeholder="10 digit Contact No." class="form-control input-md" type="text">
            			</div>
            		</div>
