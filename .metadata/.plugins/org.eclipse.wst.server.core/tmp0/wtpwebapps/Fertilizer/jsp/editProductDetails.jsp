 ...
 <div class="row header_margin_top">
 	...
 	<div class="container col-sm-offset-1">
		...
		<div class="row form-group">
			...
			<div class="row form-group">
				 <label class="col-md-2 control-label" for="existedTax">Existed Tax Type</label>  
	            	<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
								No
					...
					<label class="col-md-2 control-label" for="existedTaxPercentage">Existed Tax Percentage</label>
						<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
								%
