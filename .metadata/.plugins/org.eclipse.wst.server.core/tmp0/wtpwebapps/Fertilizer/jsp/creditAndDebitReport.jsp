...
<script src="/Fertilizer/staticContent/js/customerbillreport.js"></script>
  ...
  <div class="col-xs-9" style="margin-top: -38px;">
    ...
    <div class="tab-pane active" id="homeToday">
     ...
     <div class="tab-pane" id="profile">
	       <div class="row">
			<div align="center" style="margin-top: 20px">
				  <h2 class="form-name style_heading">Day Wise Credit Debit Reports</h2>
			</div>
 ...
 <div class="tab-content" style="float: left;margin-top:12px;">
    ...
    <div id="credit" class="tab-pane fade in active"> 		
 	 ...
 	 <ul class="nav nav-tabs">
	    <li class="active"><a data-toggle="tab" href="#homeCredit"><h4 style="color:blue">Credit By Credit Customer</h4></a></li>
	    <li><a data-toggle="tab" href="#twoDatesBillilng"><h4 style="color:blue">Credit By Billilng</h4></a></li>
	     <!-- <li><a data-toggle="tab" href="#twoYears"><h4 style="color:blue">Between Two Years</h4></a></li> -->
 	 </ul>
										...
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-user"></i>
				           		 			  ...
				           		 			  <input type="date" id="fisDatetwoDatesBillilng" placeholder="Start Date" class="form-control input-md" type="text" >
				           		 		</div>
									</div>
									...
									<div class="input-group">
										<span class="input-group-addon">
											<i class="glyphicon glyphicon-map-marker"></i>
				         	   			  ...
				         	   			  <input type="date" id="endDatetwoDatesBillilng" placeholder="End Date" class="form-control input-md ac_district"  type="text">
				          		  	</div>
								</div>
				          </div>
										...
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-user"></i>
				           		 			  ...
				           		 			  <input type="date" id="fisDateSup" placeholder="Start Date" class="form-control input-md" type="text" >
				           		 		</div>
									</div>
									...
									<div class="input-group">
										<span class="input-group-addon">
											<i class="glyphicon glyphicon-map-marker"></i>
				         	   			  ...
				         	   			  <input type="date" id="endDateSup" placeholder="End Date" class="form-control input-md ac_district"  type="text">
				          		  	</div>
								</div>
				          </div>
										...
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-user"></i>
				           		 			  ...
				           		 			  <input type="date" id="fisDateEmp" placeholder="Start Date" class="form-control input-md" type="text" >
				           		 		</div>
									</div>
									...
									<div class="input-group">
										<span class="input-group-addon">
											<i class="glyphicon glyphicon-map-marker"></i>
				         	   			  ...
				         	   			  <input type="date" id="endDateEmp" placeholder="End Date" class="form-control input-md ac_district"  type="text">
				          		  	</div>
								</div>
				          </div>
