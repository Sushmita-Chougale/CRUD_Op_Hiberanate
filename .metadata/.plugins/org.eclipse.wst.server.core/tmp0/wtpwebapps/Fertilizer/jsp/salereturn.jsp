...
<meta charset="utf-8">
       ...
       <script type="text/javascript" src="/Fertilizer/staticContent/js/jquery-1.11.1.min.js"></script>
     ...
     <script type="text/javascript" src="/Fertilizer/staticContent/js/fertiSaleReturn.js"></script>
           		...
           		<div class="form-group row">
            		<div class="col-md-10 text-center">
              			...
              			<button class="btn btn-large btn-danger" type="reset"> Cancel </button>
              			 -->
              			<input type="button" id="save" name="save" style="font-size: 25" class="btn btn-large btn-success button-height-width"  onclick="saleReturn()" value="Submit">
