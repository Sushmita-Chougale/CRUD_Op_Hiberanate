...
<%
	...
	try {
		...
		ResultSet rs = stmt
				.executeQuery("select customer_name, fertilizer_billing.product_name,fertilizer_billing.gross_total, fertilizer_billing.village, fertilizer_billing.company, fertilizer_billing.weight, fertilizer_billing.quantity, fertilizer_billing.salePriceWithoutTax, fertilizer_billing.total_per_product, fertilizer_billing.total_all_product, fertilizer_billing.transportation_expense, fertilizer_billing.hamali_expense, fertilizer_billing.total_per_product, insert_date,fertilizer_billing.tax_percentage,fertilizer_billing.hsn,fertilizer_billing.igstPercentage from fertilizer_billing where bill_no ="
						+ billno);
		...
		table_cell3 = new PdfPCell(
				new Phrase("Gross Total(Including Tax)", font13Bold));
		table_cell3.setColspan(9);
		table_cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell3.setPaddingBottom(5f);
		table_cell3.setPaddingTop(5f);
