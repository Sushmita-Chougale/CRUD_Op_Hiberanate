...
<head>
<script src="/Fertilizer/staticContent/js/vatpercentage.js" type="text/javascript"></script>
<script type="text/javascript" src="/Fertilizer/staticContent/js/productDetail.js"></script>
...
<script type="text/javascript">
 ...
 <div class="row header_margin_top">
 	...
 	<div class="container col-sm-offset-1">
            ...
            <label class="col-md-2 control-label" for="productName"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("productName") %> <%}%> <%if(abc.equals("english")){%>Product Name<%}%> <sup>*</sup></label>  
            	<div class="col-md-3">
            		<div class="input-group">
							...
							%>
							<input list="productName_drop" id="productName"  class="form-control" onblur="checkForDuplicateProductEntry()" style="text-transform: uppercase">
		...
		<div class="row form-group">
         	<label class="col-md-2 control-label" for="fk_tax_id">Tax Type<sup>*</sup></label>
         		<div class="col-md-3">
					<div class="input-group">
						<span class="input-group-addon">
							<i class="	glyphicon glyphicon-hand-right"></i>
           		...
           		<div class="col-md-3" >
					<div class="input-group">
						...
						Rs
              			...
              			<input id="salePrice" name="salePrice" placeholder="Sale Price" class="form-control input-md" type="text" onchange="salePriceCompaireWithMRP()">
            		</div>
				</div>
           		...
           		<div class="col-md-2" >
					<div class="input-group">
						...
						Rs
              			...
              			<input id="creditSalePrice" name="creditSalePrice" placeholder="credit Sale Price" class="form-control input-md" type="text" onchange="creditSalePriceCompaireWithMRP()">
            		</div>
				</div>
			</div>
		<div class="row form-group">
		<label class="col-md-2 control-label" for="hsn"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("salePrice") %> <%}%> <%if(abc.equals("english")){%>HSN<%}%><sup>*</sup></label>  
           		<div class="col-md-3">
					<div class="input-group">
						<span class="input-group-addon">
						Rs
