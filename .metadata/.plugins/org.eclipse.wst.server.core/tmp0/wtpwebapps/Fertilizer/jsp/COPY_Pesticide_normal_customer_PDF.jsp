...
<%
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select customer_name, p.product_name, p.village, p.company, p.weight, p.quantity, p.salePriceWithoutTax, p.total_per_product, p.total_all_product, p.transportation_expense, p.hamali_expense, p.gross_total, insert_date,p.tax_percentage,p.hsn,p.iGst from pesticide_billing p where p.bill_no =" + billno);
