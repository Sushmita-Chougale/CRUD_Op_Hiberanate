...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <script src="/Fertilizer/staticContent/js/bootstrap-select.min.js"></script>
  
  <link rel="stylesheet" href="/Fertilizer/staticContent/css/bootstrap.allPayment.min.css">
  <script src="/Fertilizer/staticContent/js/jquery.allPayment.min.js"></script>
  <script src="/Fertilizer/staticContent/js/bootstrap.allPayment.min.js"></script>
   <script src="/Fertilizer/staticContent/js/cashbankbook.js"></script>
   
 <!--   files for selectpicker -->
    <script src="/Fertilizer/staticContent/js/bootstrap-select.js"></script>
      <script src="/Fertilizer/staticContent/js/bootstrapForSelect.min.js"></script>
   
      <link rel="stylesheet" href="/Fertilizer/staticContent/css/bootstrap-select.css"> 
      <link rel="stylesheet" href="/Fertilizer/staticContent/css/bootstrap-select.min.css"> 
      <link rel="stylesheet" href="/Fertilizer/staticContent/css/bootstrapForSelect.min.css"> 
