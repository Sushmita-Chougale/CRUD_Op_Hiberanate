...
<script src="/Fertilizer/staticContent/js/saleReports.js"></script>
</head>
<div class="row" style="min-height:300px;">
  ...
  <div class="col-xs-9">
    ...
    <div class="tab-pane active" id="home">
       		<div class="row">
				    <div align="center">
				  		<h2 class="form-name style_heading">CategoryWise Sale Reports</h2>
				  	</div>
...
<!-- 	 <script type="text/javascript">
						...
						<div class="col-md-3 col-md-offset-3">
							<div class="input-group">
								<input type="button" id="btn" name="save"
									...
									onclick="saleReportBetweenTwoDatesAsPerCategory()" value="Search" />
							</div>
						</div>
				</div>
					<div	class="table-responsive">
					<table id="saleBetTwoDates" class="display" style=" border: 2px solid black;border-collapse: collapse;">
						<thead>
							<tr>
								<th>Customer Bill No</th>
								<th>Product Name</th>
					  ...
					  <div class="row form-group">
						...
						<div class="col-md-3 col-md-offset-1">
							<div class="input-group">
								<input type="button" id="btn" name="save"
									class="btn btn-lg btn-success btn-md button_hw button_margin_right"
									onclick="saleReportforSingleDateAsPerProName()" value="Search" />
							</div>
						</div>
					</div>
					<div	class="table-responsive">
					<table id="sale3" class="display" style=" border: 2px solid black;border-collapse: collapse;">
						<thead>
								<tr>
								<th>Customer Bill No</th>
								<th>Product Name</th>
				...
				<datalist id="cat_drop_For_sale">
					...
					<label class="col-md-2 control-label" for="product">Product Name<sup>*</sup></label>  
				       ...
				       <div class="row form-group buttons_margin_top ">
						...
						<table id="sale4" class="display" style=" border: 2px solid black;border-collapse: collapse;">
						<thead>
							<tr>
								<th>Customer Bill No</th>
								<th>Product Name</th>
					...
					<div class="row form-group">
				     <div class="col-md-3 Col-md-offset-1">
						<div class="input-group">
								...
								<input type="button"  id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="paymentModeReport()" value="Search"/>
												     									
						</div>
					</div>	
					</div>
					<div	class="table-responsive">
					<table id="paymentModeSelect" class="display" style=" border: 2px solid black;border-collapse: collapse;">
						<thead>
								<tr>
								<th>Customer Bill No</th>
								<th>Customer Name</th>
			...
			<form class="form-horizontal" method="post" action="" name="datepaymentMode">
				...
				<datalist id="cat_drop_For_payment_mode">
					...
					<div class="row form-group">
				     <div class="col-md-3 Col-md-offset-1">
						<div class="input-group">
								<input type="button"  id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="paymentModeReportAsPerSingleDate()" value="Search"/>
						</div>
					</div>	
					</div>
				<div class="table-responsive">
					<table id="SinglePayment" class="display" style=" border: 2px solid black;border-collapse: collapse;">
						<thead>
								<tr>
								<th>Customer Bill No</th>
		...
		<div id="rangeWisePaymentMode" class="tab-pane">
			<form class="form-horizontal" method="post" action="" name="twoDatepaymentMode">
				...
				<datalist id="cat_drop_For_payment_mode_two">
				     ...
				     <div class="col-md-3 Col-md-offset-1">
						<div class="input-group">
								<input type="button"  id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="paymentModeReportForTwoDates()" value="Search"/>
						</div>
					</div>	
					</div>
				<div class="table-responsive">
					<table id="TwoPayment" class="display" style=" border: 2px solid black;border-collapse: collapse;">
						<thead>
								<tr>
								<th>Customer Bill No</th>
								<th>Cash Payment Amount</th>
 ...
 <!--  GST wise -->
  <div class="tab-pane" id="GSTWise">
			    ...
			    <form class="form-horizontal" method="post" action="" name="gst" style="margin-top: -40px;">
				<!-- 	<fieldset> -->
				...
				<div class="table-responsive">
					<table id="gstSale" class="display table table-boardered"" style=" border: 2px solid black;border-collapse: collapse;">
						<thead>
								<tr>
								<th>Sr No</th>
								<th>date</th>
