...
function gridForCredit(){
	...
	$.post('/Fertilizer/jsp/utility/controller.jsp',params,function(data)
			...
			$("#credit1").jqGrid({
				...
				colNames:['cat_id','ItemName','CompanyName','HSN','Packing','Unit','UnitPrice','MRP','Quantity', 'Total'],
				colModel:[ 
						     {
						    	 name:'cat_id',
						    	 hidden:true,
...
$("#batchNo option:selected").each(function() {
	...
	$.post('/Fertilizer/jsp/utility/controller.jsp',params,function(data)
			...
			$("#credit").jqGrid({
				...
				colNames:['cat_id','ItemName','CompanyName','HSN','Packing','Unit', 'Batch Number','UnitPrice','MRP','Quantity' ,'Total'],
				colModel:[ 
						     {
						    	 name:'cat_id',
						    	 hidden:true,
