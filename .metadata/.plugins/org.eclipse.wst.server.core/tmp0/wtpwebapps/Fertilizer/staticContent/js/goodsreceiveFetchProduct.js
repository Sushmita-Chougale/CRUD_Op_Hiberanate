...
function prodetail(){
	...
	$.post('/Fertilizer/jsp/utility/controller.jsp',itemparams,function(data)
			{
		var jsonData = $.parseJSON(data);
		$.each(jsonData,function(i,v)
				{
	...
	$.post('/Fertilizer/jsp/utility/controller.jsp',itemparams,
		...
		$.each(jsonData,function(i,v)
			...
			$("#jqGrid").jqGrid({
				...
				colNames: ["Cat Id","Product ID","Product Name","Company","Buy Price","M.R.P","Sale Price","Packing","Quantity","Total","BatchNo","ExpiryDate" ],
...
/*			 function sumFmatter (cellvalue, options, rowObject)
			...
			$.each(jsonData,function(i,v)
				...
				$("#jqGrid").jqGrid({
					...
					colNames: [	"Cat ID","Product ID","Product Name","Company","HSN","Buy Price","M.R.P","Sale Price","Packing","CGST %","SGST %","IGST %","Quantity","Total","BatchNo","ExpiryDate" ],
